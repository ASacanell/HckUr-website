    $(document).ready(
            function() {
				...
				$(document).on("click", "#AS", function() {				
					...
					setTimeout(function(){
						$.ajax({
							type: "POST", url: "../cvs/AS/english.html", success: function(a) {
								$('#rest').html(a);
							}
						});		
					}, 100);
				...
				$(document).on("click", "#DP", function() {				
					...
					setTimeout(function(){
						$.ajax({
							type: "POST", url: "../cvs/DP/english.html", success: function(a) {
								$('#rest').html(a);
							}
						});		
					}, 100);
				...
				$(document).on("click", "#CB", function() {				
					...
					setTimeout(function(){
						$.ajax({
							type: "POST", url: "../cvs/CB/english.html", success: function(a) {
								$('#rest').html(a);
							}
						});		
					}, 100);
